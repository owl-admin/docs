"use strict";(self.webpackChunkrspress_doc_template=self.webpackChunkrspress_doc_template||[]).push([["4245"],{1530:function(t,e,s){s.r(e),s.d(e,{default:function(){return m}});var a=s(2676),i=s(7416),l=s(1478),n=s(5271),r=s(4004),o=s(7504),c=s(993),d=s(1106);let m=()=>{let[t,e]=(0,n.useState)([]),s=async()=>{let t=await fetch("/extension-data.json"),s=await t.json();for(let t of s){let e=new Date(t.latest_update),s=Math.floor((new Date-e)/864e5);t.latest=s<7?1:0}e(s)};return(0,n.useEffect)(()=>{s()},[]),(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("style",{children:`
